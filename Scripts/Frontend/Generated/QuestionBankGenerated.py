...
class Ui_ViewAllQuestions(object):
    def setupUi(self, ViewAllQuestions):
        ...
        ViewAllQuestions.resize(800, 786)
        font = QtGui.QFont()
    ...
    def retranslateUi(self, ViewAllQuestions):
        ...
        self.pbEditQuestion.setText(_translate("ViewAllQuestions", "Add Question"))
        self.pbDeleteQuestion.setText(_translate("ViewAllQuestions", "Edit Question"))
        self.pbAddQuestion.setText(_translate("ViewAllQuestions", "Delete question"))
